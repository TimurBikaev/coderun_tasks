...
Сортировка шейкером является вариантом пузырьковой сортировки, который направлен на улучшение производительности 
в некоторых случаях, особенно когда большие элементы находятся близко к концу массива. 
Однако в общем случае она имеет такую же квадратичную сложность, как и обычная пузырьковая сортировка
